...
- [Javascript Regex](#javascript-regex)
  ...
  - [Section 5. Look Around](#section-5-look-around)
  - [Section 6. Regex methods](#section-6-regex-methods)
...
By the end of the series, you’ll gain the skills and confidence to write regular expressions and to match, search, and manipulate strings effectively.
