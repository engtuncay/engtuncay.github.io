...
- [JavaScript DOM Projects](#javascript-dom-projects)
...
- Toggle Password Visibility :Learn how to toggle the visibility of the password.

- Word Counter :A step-by-step guide you on how to develop a Word Counter app.

- Wikipedia Search : Build a Wikipedia Search application from scratch.

- Form Validation : Show you how to implement Form Validation using JavaScript

- Countdown Timer : Make a reusable countdown timer and use it to build the New Year countdown.

- Infinite Scroll : Implement an infinite scroll contents using JavaScript.
